...
import { MESSAGE_TYPE, RESPONSE_TYPE, BCSCHROME_ACCOUNT_CHANGE } from '../../constants';
...
export default class SessionController extends IController {
  ...
  */
  public clearSession = () => {
    ...
    this.main.inpageAccount.sendInpageAccountAllPorts(BCSCHROME_ACCOUNT_CHANGE.LOGOUT);
  }
