import { networks, Network } from 'bcsjs-wallet';
...
export default class NetworkController extends IController {
  public static NETWORKS: QryNetwork[] = [
    new QryNetwork(NETWORK_NAMES.MAINNET, networks.mainnet, 'https://bcschain.info/tx'),
    //new QryNetwork(NETWORK_NAMES.TESTNET, networks.testnet, 'http://localhost:3001/bcs-insight-api/tx'),
    //new QryNetwork(NETWORK_NAMES.REGTEST, networks.regtest, 'http://localhost:3001/bcs-insight-api/tx'),
  ];
