...
export default class SessionStore {
  ...
  @computed public get bcsBalanceUSD() {
    return isUndefined(this.bcsUSD) ? 'Loading...' : `$${this.bcsUSD} USD`;
  }
  ...
  private bcsUSD?: number = INIT_VALUES.bcsUSD;
  ...
  public init = () => {
    ...
    chrome.runtime.sendMessage({ type: MESSAGE_TYPE.GET_BCS_USD }, (response: any) => this.bcsUSD = response);
  }
  ...
  private handleMessage = (request: any) => {
    switch (request.type) {
      ...
      case MESSAGE_TYPE.GET_WALLET_INFO_RETURN:
        ...
        break;
      case MESSAGE_TYPE.GET_BCS_USD_RETURN:
        this.bcsUSD = request.bcsUSD;
        break;
      default:
        break;
    }
