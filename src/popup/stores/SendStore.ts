...
export default class SendStore {
  ...
  @observable public maxBCSSend?: number = INIT_VALUES.maxBCSSend;
  ...
  @computed public get receiverFieldError(): string | undefined {
    return isValidAddress(this.app.sessionStore.isMainNet, this.receiverAddress)
      ? undefined : 'Not a valid BCS address';
  }
  ...
  public init = () => {
    ...
    chrome.runtime.sendMessage({ type: MESSAGE_TYPE.GET_QRC_TOKEN_LIST }, (response: any) => {
      ...
      this.tokens.unshift(new QRCToken('BCS Token', 'BCS', 8, ''));
    ...
    chrome.runtime.sendMessage({
      type: MESSAGE_TYPE.GET_MAX_BCS_SEND,
    });
  }
  ...
  private handleMessage = (request: any) => {
    switch (request.type) {
      ...
      case MESSAGE_TYPE.SEND_TOKENS_FAILURE:
        ...
        break;
      case MESSAGE_TYPE.GET_MAX_BCS_SEND_RETURN:
        const bcsToken = this.tokens[0];
        this.maxBCSSend = request.maxBCSAmount / (10 ** bcsToken.decimals);
        break;
      default:
        break;
    }
