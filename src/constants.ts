export enum TARGET_NAME {
  INPAGE = 'bcschrome-inpage',
  CONTENTSCRIPT = 'bcschrome-contentscript',
  BACKGROUND = 'bcschrome-background',
}

export enum PORT_NAME {
  POPUP = 'bcschrome-popup',
  CONTENTSCRIPT = 'bcschrome-contentscript',
}
...
export enum API_TYPE {
  ...
  GET_INPAGE_BCSCHROME_ACCOUNT_VALUES = 'GET_INPAGE_BCSCHROME_ACCOUNT_VALUES',
  SEND_INPAGE_BCSCHROME_ACCOUNT_VALUES = 'BCSCHROME_ACCOUNT_CHANGED',
  CONNECT_INPAGE_BCSCHROME = 'CONNECT_BCSCHROME',
...
export enum MESSAGE_TYPE {
  ...
  GET_MAX_BCS_SEND = 'GET_MAX_BCS_SEND',
  GET_MAX_BCS_SEND_RETURN = 'GET_MAX_BCS_SEND_RETURN',
  GET_BCS_USD = 'GET_BCS_USD',
  GET_BCS_USD_RETURN = 'GET_BCS_USD_RETURN',
  ...
  GET_INPAGE_BCSCHROME_ACCOUNT_VALUES = 'GET_INPAGE_BCSCHROME_ACCOUNT_VALUES',
  SEND_INPAGE_BCSCHROME_ACCOUNT_VALUES = 'SEND_INPAGE_BCSCHROME_ACCOUNT_VALUES',
...
export enum BCSCHROME_ACCOUNT_CHANGE {
  LOGIN = 'Account Logged In',
  LOGOUT = 'Account Logged Out',
  BALANCE_CHANGE = 'BCS Account Balance Changed',
